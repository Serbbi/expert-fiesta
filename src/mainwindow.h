...
class MainWindow : public QMainWindow {
 ...
 private slots:
  ...
  void on_RainbowLayers_toggled(bool checked);
  void on_BottomHue_valueChanged(int value);
  void on_MiddleHue_valueChanged(int value);
  void on_TopHue_valueChanged(int value);
};
